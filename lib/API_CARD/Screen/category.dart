...
//          print('DEVK '+ snapshot.data.results[index].backdrop_path);
  ...
  _buildItem(String imagePath, String cate, double itemHeight, bool isFirst) {
    return Container(
      ...
      child: Card(clipBehavior: Clip.antiAliasWithSaveLayer, elevation: 10.0,
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Padding(padding: const EdgeInsets.all(15.0),
                  child: Text(cate, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Muli')),
                ),
              )
            ],
          );
