...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  Widget build(BuildContext context) {
    movieDetailBloc.fetchMovieDetail(570670);
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned( //Place it at the top, and not use the entire screen
            ...
            child: AppBar(title: Image.asset("assets/images/hacker.jpeg"), centerTitle: true, brightness: Brightness.light,
              ...
              Container(margin: EdgeInsets.only(bottom: 5),
                child: Column(mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                    ClipPath(
                      clipper: Mclipper(),
                      child: Container(alignment: Alignment.center, decoration: BoxDecoration(color: Colors.white, boxShadow: [
