...
import 'package:flutterappexample/UI_Demo/flut_store/cart.dart';
import 'package:flutterappexample/UI_Demo/flut_store/details.dart';
import 'package:flutterappexample/UI_Demo/flut_store/order_history_page.dart';
          ...
          Row(
            ...
            children: <Widget>[
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FruitAppCartView()));
                },
              ),
            ],
          ),
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FruitAppFruitDetails(fruit: fruit)));
                },
                child: Container(
                  height: 110.0,
                  width: 125.0,
