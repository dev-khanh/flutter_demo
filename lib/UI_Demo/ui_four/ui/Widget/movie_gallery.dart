...
import 'package:flutterappexample/UI_Demo/ui_four/Api_RxJava/movies_image_bloc.dart';
...
class _MovieGalleryState extends State<MovieGallery> {
  ...
  Widget buildContent(AsyncSnapshot<MovieImageModel> snapshot, BuildContext context) {
    ...
    return Container(height: width / 3, margin: EdgeInsets.only(bottom: 50, top: 10),
  ...
  _buildItem(String imagePath, double itemHeight, bool isFirst) {
    return Card(clipBehavior: Clip.antiAliasWithSaveLayer, elevation: 10.0,
      ...
      child: Image.network('https://image.tmdb.org/t/p/w500$imagePath', fit: BoxFit.cover, width: itemHeight * 4 / 3, height: itemHeight / 2,),
    );
  }
}