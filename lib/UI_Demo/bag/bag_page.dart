...
import 'package:flutterappexample/UI_Demo/bag/list_recommen.dart';
import 'app_icons.dart';
import 'bag_item_widget.dart';
import 'bag_sliver_persistent_header_delegate.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: RaisedButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ListRecommen()));
                  },
