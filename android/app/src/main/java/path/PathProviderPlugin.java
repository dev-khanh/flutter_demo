...
public class PathProviderPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    instance.channel = new MethodChannel(registrar.messenger(), "plugins.flutter.io/devk_path_provider");
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    channel = new MethodChannel(binding.getFlutterEngine().getDartExecutor(), "plugins.flutter.io/devk_path_provider");
