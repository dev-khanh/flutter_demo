...
import com.example.flutterappexample.MainActivity;
import com.example.flutterappexample.R;
...
//        Log.i(TAG, "Last client unbound from service 3");
        if (!mChangingConfiguration && Utils.requestingLocationUpdates(this)) {
            Log.i(TAG, "Starting foreground service 5");
...
//            Log.e(TAG, "Lost location permission. Could not remove updates. " + unlikely);
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.launch_background, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.launch_background, getString(R.string.remove_location_updates),
    ...
    private void onNewLocation(Location location) {
        ...
        // Toast.makeText(getApplicationContext(),"Độ chính xác: " + location.getAccuracy(),Toast.LENGTH_SHORT).show();
